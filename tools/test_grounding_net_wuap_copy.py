...
from maskrcnn_benchmark.engine.inference_wuap import inference
...
def main():
    ...
    parser.add_argument(
        "--prompt",
        default='circle purple nucleus.circle blue nucleus.circle black nucleus.round purple nucleus.round blue nucleus. round black nucleus.oblong purple nucleus.oblong blue nucleus.oblong black nucleus.',
        help="prompt",
    )
