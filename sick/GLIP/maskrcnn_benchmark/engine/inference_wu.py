...
def inference(
    ...
    if cfg.GLIPKNOW.PARALLEL_LANGUAGE_INPUT:
        ...
        assert(0)
    all_queries[0]='oval black cell . elliptical red cell. round red cell. round red nucleus. round purple cell. round purple nucleus. \
round black cell. round black nucleus. round deep purple cell. round deep purple nucleus. \
 elliptical red nucleus. elliptical purple cell. elliptical purple nucleus. \
elliptical black cell. elliptical black nucleus. elliptical deep purple cell. elliptical deep purple nucleus.\
oval red cell. oval red nucleus. oval purple cell. oval purple nucleus. \
 oval black nucleus. oval deep purple cell. oval deep purple nucleus.'+all_queries[0]
