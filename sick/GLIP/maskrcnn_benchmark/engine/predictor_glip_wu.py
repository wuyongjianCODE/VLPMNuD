...
class GLIPDemo(object):
    ...
    def overlay_entity_names(self, image, predictions, names=None, text_size=1.0, text_pixel=2, text_offset = 10, text_offset_original = 4):
        ...
        # '
        MY_LABELS = 'oval black cell . elliptical red cell. round red cell. round red nucleus. round purple cell. round purple nucleus. \
...
oval red cell. oval red nucleus. oval purple cell. oval purple nucleus. \
 oval black nucleus. oval deep purple cell. oval deep purple nucleus.'
