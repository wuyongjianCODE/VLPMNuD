...
def main():
    ...
    parser.add_argument(
        "--config-file",
        default="configs/pretrain/glip_Swin_L.yaml",#configs/grounding/e2e_dyhead_SwinT_S_FPN_1x_od_grounding_eval.yaml",
        metavar="FILE",
        help="path to config file",
    )
    parser.add_argument(
        "--weight",
        default="glip_large_model.pth",
        metavar="FILE",
        help="path to config file",
    )
